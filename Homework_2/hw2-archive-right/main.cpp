...
int main(int argc, char *argv[]) {
    ...
    if (test) {
        ...
        inputPath = am.get("input");
        commandsPath = am.get("command");
        outputPath = am.get("output");
    } else {
        inputPath = "../hw2/testcase/input22.txt";
        commandsPath = "../hw2/testcase/command22.txt";
        outputPath = "../hw2/testcase/output22";
    }
